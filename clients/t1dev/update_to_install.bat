...
rcedit "safety-browser.exe" --set-version-string "CompanyName" "Tripleonetech" 
rcedit "safety-browser.exe" --set-version-string "FileDescription" "Safety Browser"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "Safety Browser"
