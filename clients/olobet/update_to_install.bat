...
rcedit "safety-browser.exe" --set-version-string "FileDescription" "Olobet Safety Browser"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "Olobet Safety Browser"
