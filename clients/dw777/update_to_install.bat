...
rcedit "safety-browser.exe" --set-version-string "CompanyName" "美高梅" 
rcedit "safety-browser.exe" --set-version-string "FileDescription" "美高梅浏览器"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "美高梅浏览器"
