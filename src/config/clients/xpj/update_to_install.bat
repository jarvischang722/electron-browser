...
rcedit "safety-browser.exe" --set-version-string "CompanyName" "新葡京"
rcedit "safety-browser.exe" --set-version-string "FileDescription" "新葡京安全浏览器"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "新葡京安全浏览器"
