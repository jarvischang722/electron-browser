...
rcedit "safety-browser.exe" --set-version-string "CompanyName" "澳门葡京"
rcedit "safety-browser.exe" --set-version-string "FileDescription" "澳门葡京安全浏览器"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "澳门葡京安全浏览器"
