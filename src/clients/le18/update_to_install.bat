...
rcedit "safety-browser.exe" --set-version-string "CompanyName" "乐赢" 
rcedit "safety-browser.exe" --set-version-string "FileDescription" "乐赢安全浏览器"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "乐赢安全浏览器"
