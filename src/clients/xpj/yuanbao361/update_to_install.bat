...
rcedit "safety-browser.exe" --set-version-string "CompanyName" "元宝娱乐" 
rcedit "safety-browser.exe" --set-version-string "FileDescription" "元宝娱乐安全浏览器"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "元宝娱乐安全浏览器"
