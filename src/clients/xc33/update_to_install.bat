...
rcedit "safety-browser.exe" --set-version-string "CompanyName" "新橙娱乐" 
rcedit "safety-browser.exe" --set-version-string "FileDescription" "新橙娱乐安全浏览器"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "新橙娱乐安全浏览器"
