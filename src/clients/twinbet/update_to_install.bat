...
rcedit "safety-browser.exe" --set-version-string "CompanyName" "Twinbet" 
rcedit "safety-browser.exe" --set-version-string "FileDescription" "Twinbet Safety Browser"
rcedit "safety-browser.exe" --set-version-string "LegalCopyright" "Copyright 2017"
rcedit "safety-browser.exe" --set-version-string "ProductName" "Twinbet Safety Browser"
